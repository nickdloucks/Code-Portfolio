...
function telephoneCheck(phone) {
    ...
    if(!end){return false;} // if the end of the provided string does not match the pattern for the last 7 digits, it's not a valid phone number
...
// The second part of this function validates the beginning of the phone number if the end of the phone number is valid.
    ...
    if (areaCode){ // this block is for when the area code is surrounded by parentheses (on both sides, facing the proper direction)
        ...
        return final;
    }else{ // this block is for when the area code does NOT have parentheses
