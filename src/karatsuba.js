function karatsuba(x, y) {
  // PLEASE SEE PYTHON VERSION OF THIS PROJECT! IT IS MORE ACCURATE FOR LARGER INPUTS
  let x_string = x.toString();
  let y_string = y.toString();

  if (x_string.length <= 4 || y_string.length <= 4) {
    // minimum 4 digits to use Karatsuba, otherwise use brute force
    return x * y;
  } else {
